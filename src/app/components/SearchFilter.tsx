      ...
      <div className="relative flex items-center gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full h-10 pl-10 pr-4 border border-border rounded-[var(--radius-input)] bg-input-background focus:ring-2 focus:ring-ring/50 focus:border-ring outline-none text-[var(--text-sm)] text-foreground transition-shadow"
          />
        </div>
