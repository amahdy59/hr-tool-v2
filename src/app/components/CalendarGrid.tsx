  ...
  return (
    <div className="bg-card border border-border rounded-[var(--radius-card)] overflow-hidden shadow-[var(--elevation-sm)]">
      ...
      <div className="grid grid-cols-7 border-b border-border">
        {days.map((day) => (
          <div key={day} className="py-3 text-start ps-[12px] text-[var(--text-sm)] font-[var(--font-weight-medium)] text-muted-foreground bg-muted/50 border-e border-border last:border-e-0">
            {day}
          </div>
        ))}
      </div>
