...
const dictionary: Record<string, string> = {
  ...
  'Bereavement': 'وفاة',
  'Unpaid': 'غير مدفوعة',
  'Maternity (appears only to females)': 'أمومة (تظهر للإناث فقط)',
  'Paternity (appears only to males)': 'أبوة (تظهر للذكور فقط)',
  'Please ensure all carried-over vacation days from last year are used before 31st this March. Carried over days are deducted automatically before this year\'s vacation.': 'يرجى التأكد من استخدام جميع أيام الإجازة المرحلة من العام الماضي قبل 31 مارس من هذا العام. يتم خصم الأيام المرحلة تلقائيًا قبل إجازة هذا العام.',
