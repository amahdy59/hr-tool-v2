...
const dictionary: Record<string, string> = {
  ...
  "Carried over days are deducted automatically before this year's vacation.": "تخصم ايام الاجازة المرحلة تلقائيا قبل اجازة هذا العام.",
  ...
  "Please ensure all carried-over vacation days from last year are used before ": "يرجى التاكد من استخدام جميع ايام الاجازة المرحلة من العام الماضي قبل ",
