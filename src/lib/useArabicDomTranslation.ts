...
const dictionary: Record<string, string> = {
  ...
  "1 week": "اسبوع واحد",
  "Please ensure all carried over vacation days are used before March 31st of the current year. Any remaining carried over days will be automatically deducted before the current year's vacation.": "يرجى التأكد من استخدام جميع أيام الإجازة المُرحلة من العام الماضي قبل 31 مارس من هذا العام. تُخصم أيام الإجازة المُرحلة تلقائيًا قبل إجازة هذا العام.",
