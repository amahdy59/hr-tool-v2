...
const dictionary: Record<string, string> = {
  ...
  "Carried over days are deducted automatically before this year's vacation.": "تُخصم أيام الإجازة المٌرحلة تلقائيًا قبل إجازة هذا العام.",
  ...
  "Leave balance summary": "ملخص رصيد الأجازة",
  "Leaves": "الأجازات",
  ...
  "Remember me": "تذكرني",
  "Remote": "عن بُعد",
  "Book mission": "حجز المامورية",
  "✈ Book mission": "✈ حجز المامورية",
  "Book time off": "حجز الاجازة",
  "✈ Book time off": "✈ حجز الاجازة",
  "Remove": "إزالة",
  "Req Date": "تاريخ الطلب",
  "Request a mission": "حجز المامورية",
  ...
  "Usability Testing": "اختبارات سهولة الاستخدام",
  "Wireframing": "تخطيط الهيكل السلكي",
  "Prototyping": "بناء النماذج الأولية",
  "Figma": "فيجما",
  "Design Systems": "أنظمة التصميم",
  "Enterprise & SaaS Design": "تصميم الأنظمة المؤسسية وبرمجيات الخدمة",
  "Adobe Creative Suite": "مجموعة أدوات أدوبي الإبداعية",
  ...
  "KPI Analysis": "تحليل مؤشرات الأداء الرئيسية",
  "User Experience Designer": "مصمم تجربة المستخدم",
  "Instructional Designer": "مصمم تعليمي",
  "Advansys IS": "أدفانسيس لنظم المعلومات",
  "Schneider Electric": "شنايدر إلكتريك",
  ...
  "Diploma of Education": "دبلوم التعليم",
  "Instructional Technology": "تكنولوجيا التعليم",
  "Minufiya University": "جامعة المنوفية",
  "Bachelor's degree": "درجة البكالوريوس",
  "Radio and Television": "الراديو والتلفزيون",
  "Excellent": "امتياز",
  "Good": "جيد",
  "Haj Arafa App": "تطبيق حاج عرفة",
  "Cairo International Airport - Command Hub": "مطار القاهرة الدولي - مركز التحكم",
  "Human Resources Tool": "أداة الموارد البشرية",
  "A Data-Driven LEGO Explorer": "مستكشف ليغو المعتمد على البيانات",
  "Sales Performance Dashboard": "لوحة قياس أداء المبيعات",
  "Google Data Analytics": "تحليل بيانات جوجل",
  "Tableau Business Intelligence Analyst": "محلل ذكاء الأعمال من تابلو",
  "Excel Skills for Data Analytics and Visualization": "مهارات إكسل لتحليل البيانات وتصويرها",
  "Excel Skills for Business": "مهارات إكسل للأعمال",
  "Google UX Design": "تصميم تجربة المستخدم من جوجل",
  "Led UX/UI design for complex B2B and enterprise SaaS platforms, driving user-centric solutions. Established scalable design systems utilizing Figma, Adobe Creative Suite, and modern methodologies. Leveraged AI-powered design tools to accelerate rapid prototyping and UX research synthesis.": "قاد تصميم تجربة وواجهة المستخدم للمنصات السحابية المعقدة والمؤسسية (B2B)، مما دفع بالحلول المرتكزة على المستخدم. أنشأ أنظمة تصميم قابلة للتوسع باستخدام فيجما، ومجموعة أدوات أدوبي الإبداعية، والمنهجيات الحديثة. استفاد من أدوات التصميم المدعومة بالذكاء الاصطناعي لتسريع بناء النماذج الأولية وتوليف أبحاث تجربة المستخدم.",
  "Redesigned enterprise learning platforms and interfaces, increasing user engagement and training completion rates by 30%. Translated complex technical requirements into accessible, intuitive B2B e-learning experiences.": "أعاد تصميم منصات وواجهات التعلم المؤسسية، مما زاد من تفاعل المستخدمين ومعدلات إكمال التدريب بنسبة 30%. ترجم المتطلبات التقنية المعقدة إلى تجارب تعليم إلكتروني ميسرة وسهلة للمؤسسات.",
  "An intuitive, accessible e-commerce experience designed with responsive layouts and seamless navigation to maximize user conversion and engagement.": "تجربة تجارة إلكترونية سهلة وميسرة مصممة بتخطيطات متجاوبة وتصفح سلس لزيادة تفاعل وتحويل المستخدمين.",
  "A high-fidelity operational command dashboard focusing on real-time data visualization, clear information hierarchy, and responsive performance.": "لوحة تحكم تشغيلية عالية الدقة تركز على تصوير البيانات الفورية، والتسلسل الهرمي الواضح للمعلومات، والأداء المتجاوب.",
  "A responsive, privacy-centric HR SaaS application optimizing leave requests and role management through modern, user-friendly interfaces.": "تطبيق موارد بشرية متجاوب ومحمي الخصوصية يحسن طلبات الأجازات وإدارة الأدوار من خلال واجهات حديثة وسهلة الاستخدام.",
  "An interactive Tableau visualization experience that helps users explore LEGO sets by theme, age, price, and set count.": "تجربة تصويرية تفاعلية على تابلو تساعد المستخدمين على استكشاف مجموعات ليغو حسب السمة، والسن، والسعر، وعدد القطع.",
  "CRM sales dashboard built in Google Sheets for tracking quarterly team performance through chart-based visualization.": "لوحة تحكم لمبيعات علاقات العملاء (CRM) تم إنشاؤها في جداول بيانات جوجل لتتبع الأداء الربع سنوي للفريق من خلال التصوير البياني.",
  "Your Role": "دورك"
};
